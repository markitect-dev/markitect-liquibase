...
dependencies {
    ...
    constraints {
        ...
        annotationProcessor(libs.commons.codec.commons.codec)
        annotationProcessor(libs.commons.collections.commons.collections)
        annotationProcessor(libs.commons.io.commons.io)
        annotationProcessor(libs.commons.logging.commons.logging)
        ...
        annotationProcessor(libs.org.apache.commons.commons.compress)
