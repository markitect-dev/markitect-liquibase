...
/** Generates SQL Server upsert statements for insert-or-update changes. */
public class MarkitectInsertOrUpdateGeneratorMssql extends InsertOrUpdateGeneratorMSSQL
  ...
  public PreparedSql prepareInsertOrUpdateSql(
    ...
    String sql =
        "UPDATE "
            ...
            + ")";
    var bindColumns =
        Stream.of(updateValues, whereValues, columnValues)
