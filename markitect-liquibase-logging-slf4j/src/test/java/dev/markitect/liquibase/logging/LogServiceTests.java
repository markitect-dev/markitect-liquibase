...
import dev.markitect.liquibase.logging.slf4j.Slf4jLogService;
import dev.markitect.liquibase.logging.slf4j.Slf4jLogger;
...
class LogServiceTests {
  ...
  void logs(CapturedOutput output) {
    ...
    // then
    assertThat(logService).isInstanceOf(Slf4jLogService.class);
